...
|-------|-------------|--------|
| **W1** | API: list / get / update forms | pending |
| **W2** | Prebuilt renderer runtime artifact + form shell template | pending |
| **W3** | Workspace shell: login, forms list (served at `/admin`) | pending |
